...
- **No fixture-level operations.** To add, change, or remove a fixture, edit
  the `InteriorSpace`'s `interiorLightingSpace.fixture[]` list and pass the
