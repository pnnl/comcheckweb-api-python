...
from comcheck_api.types.api_types import ComBuilding, InteriorLightingSpace, AgWallAssembliesUValuesArgs, AssembliesUValuesArgs, BgWallAssembliesUValuesArgs
