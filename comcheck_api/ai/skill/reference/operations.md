...
Use `get_default_interior_space_template()` as a starting point.
...
Neither call mutates the `InteriorSpace` objects or writes onto
...
Use `get_default_exterior_area_template()` as a starting point.
